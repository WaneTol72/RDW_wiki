...
3. **Используйте Markdown**: вся документация написана с использованием Markdown. Если вы не знакомы с этим языком разметки, загляните в [краткое руководство по Markdown](markdown_guide.md).
...
Начните свое знакомство с документацией с раздела [Основы тестирования](TestingBasics.md) или выберите интересующий вас раздел в меню.