...
:::tip
Если после выбора одного из вариантов *"Выключение или перезагрузка"* изделие осталось включённым, введите команду ***Poweroff*** для выключения, либо ***Reboot*** для перезагрузки, регистр не важен.
:::
