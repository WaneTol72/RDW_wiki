...
> [!tip] **Примечание:**
> Если после выбора одного из вариантов *"Выключение/перезагрузка"* изделие осталось включённым, введите команду ***Poweroff*** для выключения, либо ***Reboot*** , регистр не важен.
