...
2) Проверка данных: 
	...
	- **Датчик удара:** - Большие усилия прилагать не следует, дабы не оставить повреждения (вмятина, трещины и т.п.).
		- Нужно физически ударить устройство по корпусу (лучше в месте или со стороны нахождения самого **ПЗПК**).
		- Если это **PC**, можно немного приподнять за лицевую сторону, и отпустить.
