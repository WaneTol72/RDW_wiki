...
2) Проверка данных: 
	...
	- **Датчик удара:** - Большие усилия прилагать не следует, дабы не оставить повреждения (вмятина, трещины и т.п.).
		...
		- В программе выбрать пункт **Датчик удара** и проверить что данные отобразились верно (**дата и время** проведения данной манипуляции с устройством). Если данные отобразились не корректно (без даты и времени), нужно выйти из и повторить с 3 по 5.
