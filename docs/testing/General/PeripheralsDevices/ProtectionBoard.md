...
### Проверка данных: 
	...
	5. В программе выбрать пункт *Датчик удара* и проверить что данные отобразились верно (**дата и время** проведения данной манипуляции с устройством). Если данные отобразились не корректно (без даты и времени), нужно выйти с данного пункта и повторить с 3 по 5.
