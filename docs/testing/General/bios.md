...
:::note Обязательно проверяем заряд батарейки путем выключения устройства и сброса остаточного питания. *Для блоков питания повышенной мощности требуется больше времени.*
:::
